...
Animal::Animal(string  cod, string nume, double pret, string data_introducerii, double  nr_exemplare_disponibile, double varsta) : Magazin(cod, nume, pret, data_introducerii, nr_exemplare_disponibile) {
	this->varsta = varsta;
}
