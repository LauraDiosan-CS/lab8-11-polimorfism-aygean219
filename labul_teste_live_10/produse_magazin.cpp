...
Produs::Produs(string  cod, string nume, double  pret, string data_introducerii, double nr_exemplare_disponibile, string  data_expirarii) : Magazin(cod, nume, pret, data_introducerii, nr_exemplare_disponibile) {
